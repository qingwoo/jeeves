...
public class WechatUrlPropertiesTest {
    ...
    public void userAvatarPattern() {
        ...
        Matcher matcher = WechatUrlProperties.USER_AVATAR_PATTERN.matcher(body);
    ...
    public void redirectUrlPattern() {
        ...
        Matcher matcher = WechatUrlProperties.REDIRECT_URL_PATTERN.matcher(body);
        Assert.assertTrue(matcher.find());
